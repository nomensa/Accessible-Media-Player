...
* window.nomensaPlayer.PlayerDaemon and getting a reference to the object instance from the DOM).
*-------------------------------------------------------------------------------------------*/
function vimeo_player_loaded(player_id){
	var player = window.nomensaPlayer.PlayerDaemon.getPlayer(player_id);
